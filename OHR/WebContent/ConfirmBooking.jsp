...
<!-- box begin -->
				<div class="box maxheight">
					<div class="inner">
						<h3>Payment :</h3>		
						<% float roomCost=(Float)session.getAttribute("cost");
						   float serviceCost=(Float)session.getAttribute("totalService");
						   float totalAmount=roomCost+serviceCost;
						   System.out.println(totalAmount);
						   session.setAttribute("tc",totalAmount);
					    %>				
						<form  action="RMIClient" id="Confirm" style="height: 228px; width: 303px">
					 		<fieldset>
								<div class="field"><label>Total Amount:</label><input type="text" value="<%=totalAmount %>" name="txtAmt" disabled="disabled" style="width: 100px; height: 17px"/></div>
								<div class="field"><label>Card Number:</label><input type="text" name="txtCardNo" style="width: 100px; height: 17px"/></div>
								<div class="field"><label>Pin                :</label>   <input type="password" name="txtPin" style="width: 100px; height: 17px"/></div>
