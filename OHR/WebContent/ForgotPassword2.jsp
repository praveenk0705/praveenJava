...
<!-- box begin -->
				<div class="box maxheight">
					...
					stSelect=connection.prepareStatement("select * from registration where username=?");
				   ...
				   stSelect.setString(1,uName);
				    ...
				    if(result.next())
				    {
				    	sQuestion=result.getString("Squestion");
				    ...
				    response.sendRedirect("ForgotPassword.jsp"); 
						...
						<form  action="ForgotPassword3.jsp" id="ForgotPassword" style="height: 228px; width: 343px">
					 		<fieldset style="width: 463px; ">
								...
								<br>Secret Question:<input type="text" name="sQues" value=<%=sQuestion %> style="width: 174px; height: 17px"><br>
								
								<br><br>Please Enter your secret answer :<input type="text" name="sAnswer" style="width: 77px; height: 17px"></div>
