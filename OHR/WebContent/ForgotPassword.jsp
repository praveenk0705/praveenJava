...
<!-- box begin -->
				<div class="box maxheight">
					<div class="inner">
						...
						<form  action="ForgotPassword2.jsp" id="ForgotPassword" style="height: 228px; width: 343px">
					 		<fieldset>
								<div class="field"><label>Please enter the UserName:</label><input type="text" name="txtName" style="width: 164px; height: 17px"/></div>
