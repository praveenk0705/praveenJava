...
<!-- box begin -->
				<div class="box maxheight">
					...
					<h3>Special Services</h3>
							<ul>
								<li><b><font size="2">Laundary</font></b></li>
								<li><b><font size="2">Cab Facility-Pick & Drop</font></b></li>
								<li><b><font size="2">InterNet Facility</font></b></li>
								<li><b><font size="2">Gym  & Spa Centre</font></b></li>
								<li><b><font size="2">City Darshan</font></b> </li>
							</ul>
					</div>
				</div>
<!-- box end -->
