...
<!-- box begin -->
				<div class="box maxheight">
					...
					<form  action="ConfirmBooking.jsp" id="FinalBooking" style="height: 462px; width: 299px">
...
<tr><td> Booking Id &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" value="<%=++id%>" disabled="disabled" /></td></tr>
<tr><td> Room Type  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="<%=roomType %>" disabled="disabled" /> </td></tr>
<tr><td> User Name  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="<%=name%>" disabled="disabled" />  </td></tr>
<tr><td> Check In Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="<%=checkIn%>" disabled="disabled" /> </td></tr>
<tr><td> Check Out Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" value="<%=checkOut %>" disabled="disabled" /></td></tr>
<tr><td> Total No Of Room &nbsp; &nbsp;<input type="text" value="<%=noRoom %>" disabled="disabled" /></td></tr>
<tr><td> Total No Of Person &nbsp;<input type="text" value="<%=person %>" disabled="disabled" />  </td></tr>
<tr><td> Room Cost &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;     <input type="text" value="<%=cost %>" disabled="disabled" />   </td></tr>


<tr><td><h4>Services</h4></td></tr>
<tr><td>Laundary &nbsp;&nbsp;&nbsp; &nbsp;<input type="text" value="<%=Pservice1%>" disabled="disabled" /></td></tr>
<tr><td>Cab Facility&nbsp;&nbsp;&nbsp; &nbsp;<input type="text" value="<%=Pservice2%>" disabled="disabled" /></td></tr>
<tr><td>Internet&nbsp;&nbsp;&nbsp; &nbsp;<input type="text" value="<%=Pservice3%>" disabled="disabled" /></td></tr>
<tr><td>Gym & Spa&nbsp;&nbsp;&nbsp; &nbsp;<input type="text" value="<%=Pservice4%>" disabled="disabled" /></td></tr>
<tr><td>City Darshan&nbsp;&nbsp;&nbsp; &nbsp;<input type="text" value="<%=Pservice5%>" disabled="disabled" /></td></tr>
<tr><td>Services Total&nbsp;&nbsp;&nbsp; &nbsp;<input type="text" value="<%=Ptotal%>" disabled="disabled" /></td></tr>


<tr><td colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" value="Confirm Booking" style="width: 116px; "></tr>
