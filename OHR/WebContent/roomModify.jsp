...
<br/>
					...
					<br/><br/>
					 ...
					 <tr><td colspan="3" align="center" ><b><font color="maroon">Detailed View of Rooms</font></b></td></tr>
	                 <tr>
	                 <td>Room Id</td>
	                 <td>Room Type</td>
	                 <td>Room Charges</td>
	            ...
	            <% 	                             
	            	 stSelect=connection.prepareStatement("select * from room");
        			 ResultSet result=stSelect.executeQuery();
	            ...
	            %>
	                 ...
	                 <form action="roomModify" >
	                 <table border="1" cellspacing="1" cellpadding="1">
	                 <tr><td colspan="1" align="center" ><b><font color="maroon">Modify Rooms</font></b></td></tr>
	                  <tr>
	                  <td> Room Id &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="roomId"></td>
	                  </tr>	                  
	                  <tr>
	                  <td> Room Type  &nbsp;&nbsp;&nbsp;<input type="text" name="roomType"></td>
	                  </tr>
	                  <tr>
	                  <td> Room Price&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="roomCharges"></td>
	                  </tr>
	                  <tr>
	                  <td>
